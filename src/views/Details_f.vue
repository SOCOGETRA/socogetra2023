<template>
    <div class="hello">
        <div class="screenUse">
            ...
            <vs-col vs-w="12" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: 100%; z-index: 1000;">
                ...
                <div style="width: 530px; float: left; display: inline-block; margin-bottom: -15px; color: black; font-size: 20px;">
                  <span style="color: #C32D39;"><vs-icon icon="home" size="" style="font-size: 18px;"></vs-icon> Administration /</span> <b>IMPORT</b> / Liste des Factures
                </div>
                <span style="float: right; margin-right: 150px;">
                      <vs-button color="#C32D39"  icon="add" style="padding: 5px; position: absolute; width: 150px;" @click="activePrompt3=true">Ajouter Facture</vs-button>
                  </span>
              ...
              <div style="padding: 10px 20px; font-family:'Karla', sans-serif; margin-top: 90px;">
                  <el-card class="box-card" style="padding: -15px; border-radius: 10px;">
                    ...
                    <h2 style="font-weight: bold;"><span><b>{{ donnees.length }} Conteneurs</b></span><el-link style="margin-left:15px" type="success" @click="ExportExcel('xls')"><img src="../assets/excel.png" width="14">Exportation Excel</el-link> - 
                      <a :href="i.fichier" style="margin-left:16px; font-size: 15px; color:#C32D39" type="primary" v-for="i in donneesDocs" :key="i.n_doc"><img src="../assets/pdf.png" width="14"> {{i.libelle}}</a>
          ...
          cancel-text="Annuler"
          @close="close"
          :active.sync="documentss">
          <div class="con-exemple-prompt">
            <div style="padding: 10px 0px;">

              <label>Libellé</label>
              <el-input style="width: 100%;" v-model="form.libelle" placeholder="Nom & Prenom">
              </el-input>
              ...
              <vs-row>
                <vs-col vs-w="8" style="padding-right: 2px;">
                  ...
                  <input @change="uploadImage($event, 'a')" type="file" placeholder="Choisir le fichier" required ref="file" name="image" id="uploadInput" class="form-control">
                  <vs-progress indeterminate color="primary" v-show="chargeFichier == 1">primary</vs-progress>
                  <vs-progress :percent="100" color="success" v-show="chargeFichier == 2">primary</vs-progress>
    ...
    methods: {
      tableRowClassName({row, rowIndex}) {
        ...
        uploadImage(e, a) {
            ...
            .then(res => {
                if(a === 'a') {
                  ...
                  this.form.fichier = fichierUrl.url;
                }
                if(a === 'b') {
        ...
        ordre () {
              ...
              fetch('https://socogetra.net/appi_socogetra/soco_paiement_detail.php?ordre='+this.dossier+'&timestamp=' + new Date().getTime())
          ...
          Docs () {
              ...
              fetch('https://socogetra.net/appi_socogetra/soco_scan_doc.php?n_doc='+this.$route.params.element+'&timestamp=' + new Date().getTime())
              .then(response => response.json())
              .then(data => {
                this.donneesDocs = data.data;
                console.log(this.donneesOrdre);
                this.$vs.loading.close();
              })
              .catch(error => {
        ...
        listeDossier () {
            ...
            axios.get('https://socogetra.net/appi_socogetra/soco_ordre_fichiers.php?id=' + this.$route.params.element + '&timestamp=' + new Date().getTime())
            .then((response) => {
        ...
        onSubmit() {
              axios.post('https://socogetra.net/appi_socogetra/soco_paiement_detail.php', this.form)
              .then((response) => {

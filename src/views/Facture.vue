<template>
    <div class="hello">
        <div class="screenUse">
            ...
            <vs-col vs-w="12" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: 100%; z-index: 1000;">
                ...
                <div style="width: 530px; float: left; display: inline-block; margin-bottom: -15px; color: black; font-size: 20px;">
                  <span style="color: #C32D39;"><vs-icon icon="home" size="" style="font-size: 18px;"></vs-icon> Administration /</span> <b>IMPORT</b> / Liste des Ordres <br>( dossier : N° <b>{{ donneesOrdre[0].n_dossier }}</b> )
                </div>
                  ...
                  <vs-table search max-items="20" pagination  stripe :data="donnees" style="font-size: 16px">
                    ...
                    <template slot-scope="{data}">
                      <vs-tr :key="indextr" v-for="(tr, indextr) in data" >
                        ...
                        <span style="color: blue; font-size: 16px">{{data[indextr].date_recept}}</span>
                        </vs-td>
  
                        <vs-td style="font-size: 16px; background: #409eff2b" :data="data[indextr].username">
                          <span style="color:red;">{{data[indextr].n_doc}}</span>
                        </vs-td>
                        ...
                        <vs-td style="font-size: 16px; width: 100px" :data="data[indextr].username">
                          {{data[indextr].client}}
                        </vs-td>
                        ...
                        <vs-td style="font-size: 16px" :data="data[indextr].username">
                          <span v-if="data[indextr].statut == 'SCANNER'">OUI</span>
          ...
          <vs-prompt
          :title="'Conteneur : '+elementChoisi.n_conteneur"
          @accept="ChangeStatut"
          @close="close"
          :active.sync="programme">
           <div class="con-exemple-prompt">
            <div v-if="elementChoisi.sejour == ''">
          ...
          <vs-popup classContent="popup-example"  title="Modification dossier" :active.sync="popupActivo5">
            <div>
              ...
              <vs-row>
                <vs-col style="padding: 5px;" vs-justify="center" vs-align="center" vs-w="4">
                  <label>Nombre de Conteneur</label>
                  <el-input-number disabled style="width: 100%;" v-model="form.nbre_tcs" :min="1" :max="1000"></el-input-number>
                </vs-col>
                <vs-col style="padding: 5px;" vs-justify="center" vs-align="center" vs-w="4">
                  <label>N° Déclaration</label>
                  <el-input v-model="form.n_declaration" placeholder="N° Déclaration">
                  ...
                  .
                    ...
                    <el-table
                          ...
                          <el-table-column
                            ...
                            label="Scanner">
                            <template slot-scope="scope">
                              <span style="color:blue" v-if="scope.row.statut == 'SCANNER'">99 000 F</span>
                            </template>
                          </el-table-column>
                          <el-table-column
                            width="75"
      ...
      tableRowClassName({row, rowIndex}) {
        ...
        ordre () {
              ...
              .then(data => {
                ...
                this.elementChoisi = this.donneesOrdre[0];
                this.form.date_recept = this.donneesOrdre[0].date_doc;
                this.form.n_doc = this.donneesOrdre[0].n_dossier;
                this.form.nbre_tcs = this.donneesOrdre[0].n_tcs;
                this.form.bl = this.donneesOrdre[0].n_bl;

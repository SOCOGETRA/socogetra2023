            ...
            <vs-col vs-w="12" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: 100%; z-index: 1000;">
                ...
                <span style="float: right; margin-right: 150px;">
                      <vs-button color="#C32D39"  icon="add" style="padding: 5px; position: absolute; width: 150px;" @click="documentss=true">Ajouter Document</vs-button>
                  </span>
  ...
  export default {
    ...
    data() {
      return {
        ...
        form: {
            n_doc: '',
            libelle: '',
            fichier: 'https://cdn4.iconfinder.com/data/icons/small-n-flat/24/user-512.png',
        },
          donneesStatut:[{
            value: 'EN_ROUTE',
            label: 'EN_ROUTE'
    ...
    methods: {
      tableRowClassName({row, rowIndex}) {
        ...
        onSubmit() {
              this.form.n_doc = this.$route.params.element;
              axios.post('https://socogetra.net/appi_socogetra/soco_scan_doc.php', this.form)
              .then((response) => {

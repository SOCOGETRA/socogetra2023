            ...
            <vs-col vs-w="12" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: 100%; z-index: 1000;">
                ...
                <div style="width: 400px; float: left; display: inline-block; margin-bottom: -15px; color: black; font-size: 20px;">
                  <span style="color: #C32D39;"><vs-icon icon="home" size="" style="font-size: 16px;"></vs-icon> FACTURATION EXPORT /</span> Dashboard
                </div>
                      ...
                      <vs-col vs-w="12" style="display: grid;">
                        ...
                        <vs-table search max-items="20" pagination  :data="donneesDossiers" style="font-size: 12px">
                          ...
                          <template slot-scope="{data}">
                            <vs-tr :state="data[indextr].n_doc.length >= 1000?'success':indextr == 2000?'danger':null" :key="indextr" v-for="(tr, indextr) in data">
                              <vs-td :data="data[indextr].n_doc">
                              ...
                              <vs-td style="font-size: 12px;" :data="data[indextr].type_c">
                                <vs-button color="primary" type="flat">{{ data[indextr].n_doc }}</vs-button>
                              </vs-td>
  ...
  export default {
    ...
    methods: {
      ...
      listeDossiers () {
              ...
              axios.get('https://socogetra.net/appi_socogetra/soco_bilan_export.php?timestamp=' + new Date().getTime())
              .then((response) => {

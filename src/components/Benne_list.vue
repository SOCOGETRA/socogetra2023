<template>
    <div class="hello" :key="cacheKey">
        <div class="screenUse">
            ...
            <vs-col vs-w="9.5" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: calc(79% - 13px); z-index: 1000;">
                ...
                <span style="float: right; margin-right: 150px;">
                      <vs-button color="#C32D39"  icon="note_add" style="padding: 5px; position: absolute; width: 150px;" @click="activePrompt2=true">Ajouter bon</vs-button>
                  </span>
              ...
              <div style="padding: 10px 20px; font-family:'Karla', sans-serif; margin-top: 70px;">
                  ...
                  <h2 style="font-weight: bold;">Liste des bons </h2>
          ...
          <vs-popup classContent="popup-example"  title="Nouveau bon" :active.sync="activePrompt2">
          <div>
            <vs-row>
  ...
  export default {
    ...
    methods: {
        ...
        listeZones () {
            ...
            axios.get('https://sarezide.com/appi/albakoos_benne.php?timestamp=' + new Date().getTime())
            .then((response) => {
        ...
        onSubmit() {
          console.log(this.form);
              axios.post('https://sarezide.com/appi/albakoos_benne.php', this.form)
              .then((response) => {
                  console.log(response);
                  this.listeZones();

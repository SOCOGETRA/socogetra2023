                          ...
                          <el-table
                            ...
                            <el-table-column
                              ...
                              <template slot-scope="scope">
                                ...
                                <div v-else>
                                    <span style="font-size: 20px; color: blue" v-if="scope.row.badt_jour < 0"><b style="font-size: 22px"> {{ scope.row.badt_jour }} jours</b></span>
                                    <span style="font-size: 20px; color: red" v-if="scope.row.badt_jour == 0"> <b style="font-size: 22px">AUJOURD'HUI</b></span>
                                    <span style="font-size: 20px; color: orange" v-if="scope.row.badt_jour > 0 && scope.row.badt_jour < 3"><b style="font-size: 22px">{{ scope.row.badt_jour }} Jours</b></span>
                                    <span style="font-size: 20px; color: green" v-if="scope.row.badt_jour > 2">{{ scope.row.badt_jour }} Jours</span>
                                </div>
                              </template>
                            </el-table-column>
                            <el-table-column
                              ...
                              <template slot-scope="scope">
                                ...
                                <div v-else>
                                    <span style="font-size: 20px; color: blue" v-if="scope.row.requete_jour == null && scope.row.livre_jour == null"><b style="font-size: 15px">PAS LIVRE<br></b></span>
                                    <span style="font-size: 20px; color: rgb(180, 77, 8)" v-if="scope.row.requete_jour == null && scope.row.livre_jour != null"><b style="font-size: 15px">PAS DE REQUETE<br> PLUS DE {{scope.row.livre_jour}} JRS</b></span>
                                    <span style="font-size: 20px; color: red" v-if="(2 - scope.row.requete_jour) == 0"> <b style="font-size: 22px">AUJOURD'HUI<br>{{scope.row.date_requete}}</b></span>
                                    <span style="font-size: 20px; color: red" v-if="(2 - scope.row.requete_jour) == 1"> <b style="font-size: 22px">DANS 24H<br>{{scope.row.date_requete}}</b></span>
                                    <span style="font-size: 20px; color: red" v-if="(2 - scope.row.requete_jour) > 2"> <b style="font-size: 22px">DETENTION<br>{{scope.row.date_requete}}</b></span>
                                </div>
                              </template>
                            </el-table-column>
                            <el-table-column
  ...
  export default {
    ...
    methods: {
        tableRowClassName({row}) {
            if (row.badt_jour < 0 && row.badt_jour >= -2) {
            return 'warning-row';
            } else if (row.badt_jour == 0 && row.livre != row.nombre) {
            return 'danger-row';
            }
            return '';
        },
      ...
      listeDossiers () {
          ...
          Resumer () {
              ...
              axios.get('https://socogetra.net/appi_socogetra/stat_bilan.php?timestamp=' + new Date().getTime())
              .then((response) => {

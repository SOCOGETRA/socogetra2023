            ...
            <vs-col vs-w="9.5" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: calc(79% - 13px); z-index: 1000;">
                ...
                <div style="width: 300px; float: left; display: inline-block; margin-bottom: -15px; color: black; font-size: 20px;">
                  <span style="color: #C32D39;"><vs-icon icon="home" size="" style="font-size: 18px;"></vs-icon> Administration  /</span> Excels lqlq
                </div>
  ...
  export default {
    ...
    methods: {
        ...
        addfile(event) {
            ...
            senddata() {
              axios.post('https://socogetra.net/appi_socogetra/soco_ordre_fichiers.php', this.tabled)
              .then((response) => {

            ...
            <vs-col vs-w="9.5" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: calc(79% - 13px); z-index: 1000;">
                ...
                <div style="width: 500px; float: left; display: inline-block; margin-bottom: -15px; color: black; font-size: 20px;">
                  <span style="color: #C32D39;"><vs-icon icon="home" size="" style="font-size: 18px;"></vs-icon> Administration /</span> Camions & Chauffeurs
                </div>
                <span style="float: right; margin-right: 150px;">
                  ...
                  <span style="float: right; margin-right: 350px;">
                      <vs-button color="#C32D39"  icon="add_location" style="padding: 5px; position: absolute; width: 150px;" @click="activePrompt3=true">Nouveau Chauffeur</vs-button>
                  </span>
                </vs-card>
              </div>
              ...
              <div style="padding: 10px 20px; font-family:'Karla', sans-serif; margin-top: 70px;">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                  <el-tab-pane label="Chauffeurs" name="first">
                    <el-card class="box-card" style="padding: -15px; border-radius: 20px;">
                            <h2 style="font-weight: bold;">Liste des Chauffeurs</h2>
                  ...
                  <el-tab-pane label="Camions" name="second">
                    <el-card class="box-card" style="padding: -15px; border-radius: 20px;">
  ...
  export default {
    ...
    methods: {
        ...
        listeCamion () {
            ...
            axios.get('https://sarezide.com/appi/albakoos_camion.php')
            .then((response) => {
        ...
        listeChauffeurs () {
            ...
            axios.get('https://sarezide.com/appi/albakoos_chauffeurs.php')
            .then((response) => {
        ...
        onSubmit() {
              axios.post('https://sarezide.com/appi/albakoos_camion.php', this.form2)
              .then((response) => {
          ...
          onSubmitChauffeur() {
              axios.post('https://sarezide.com/appi/albakoos_chauffeurs.php', this.form)
              .then((response) => {
                  console.log(response);
                  this.$vs.loading.close();
                  this.$notify.success({

            ...
            <vs-col vs-w="9.5" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: 100%; z-index: 1000;">
                ...
                <div style="width: 100%; display: inline-block; margin-bottom: -15px; color: black; font-size: 20px;">
                  <span style="color: #C32D39;"><vs-icon icon="home" size="" style="font-size: 18px;"></vs-icon> Tableau de booard /</span> EXPORT
                  <vs-button to="/administration/fichier" color="#C32D39"  icon="list" style="padding: 5px; position: absolute; width: 150px;" @click="popupActivo2=true">Historique</vs-button>
                </div>
              ...
              <div style="padding: 10px 20px; font-family:'Karla', sans-serif; margin-top: 70px;">
                  ...
                  <vs-divider position="left">BILAN ARMATEURS <b>EXPORT</b></vs-divider>
                  <vs-row>
  
                    <vs-col vs-w="4" style="padding-right: 10px;" v-for="item in donneesArmateurs" :key="item.armateur">
                        <el-card class="box-card" style="padding: -15px;  background-color: #ffffff57; border-bottom: 3px solid #13ce66;">
                          <vs-icon icon="local_shipping" size="small" bg="#009eff5c" style="color: #6285db; font-size: 20px;" round></vs-icon> <span class="titre-zone" v-if="donneesStats.dn_carb[0].total !== null && donneesStats.dn_carb[0].total !== undefined">{{item.armateur.toUpperCase()}}</span>
                             <vs-row class="space-zone">
                                <vs-col vs-w="12" style="display: grid;">
                                  <vs-row class="space-zone">
                                    <vs-col vs-w="4" style="display: grid;">
                                      <span class="sousTitre-zone"><vs-icon style=" padding: 3px; font-size: 15px" icon="inventory_2" color="white" bg="orange" round></vs-icon> <b style="font-size: 16px">STOCK</b><br><br><br>
                                      <span class="prix-zone">{{ item.nombre_autre }} <span style="font-weight: normal;">Ordre(s)</span></span></span>
                                    </vs-col>
                                   
                                    <vs-col vs-w="4" style="display: grid;">
                                      <span class="sousTitre-zone"><vs-icon style=" padding: 3px; font-size: 15px" icon="done_all" color="white" bg="#13ce66" round></vs-icon> <b style="font-size: 16px">POSE</b><br><br><br>
                                        <span class="prix-zone">{{ item.nombre_livre }} <span style="font-weight: normal;">Conteneur(s)</span></span></span>
                                    </vs-col>
  
                                    <vs-col vs-w="4" style="display: grid;">
                                      <span class="sousTitre-zone"><vs-icon style=" padding: 3px; font-size: 15px" icon="trolley" color="white" bg="#5e5ee7" round></vs-icon> <b style="font-size: 16px">RELEVE</b><br><br><br>
                                      <span class="prix-zone">{{ item.nombre_route }} <span style="font-weight: normal;">Conteneur(s)</span></span></span>
                                    </vs-col>
                                  </vs-row>
                                </vs-col>
                              </vs-row>
                    ...
                    <table border="1" ref="exportable_tables" v-show="false">
                      <tbody >
                      <tr>
                          <th>BOOKING</th>
                          <th>CLIENT</th>
                    ...
                    <vs-row>
                      ...
                      <vs-col vs-w="12" style="display: grid;">
                        ...
                        <div style="border: 1px solid #8080802e; margin: 10px; padding: 15px;">
                          <h3>LISTE DES BOOKING <el-link type="success" @click="ExportExcels('xls')"><img src="../assets/excel.png" width="14"> EXPORTER</el-link></h3>
                          <el-table
                            ...
                            <el-table-column
                              ...
                              <template slot-scope="scope">
                                <vs-chip transparent color="primary">
                                  <vs-button color="primary" type="flat" @click="Visite(scope.row.n_doc)"><b>{{ scope.row.n_doc }}</b></vs-button>
                                </vs-chip>
                              </template>
                            </el-table-column>
                            <el-table-column
                              ...
                              label="Client">
                              <template slot-scope="scope">
                                  <b style="font-size: 11px;">{{ scope.row.client }}</b>
                              </template>
                            </el-table-column>
                            <el-table-column
                              prop="name"
                              label="Armateur">
                              <template slot-scope="scope">
                                  <b style="font-size: 11px;">{{ scope.row.armateur }}</b>
                              </template>
                            </el-table-column>
                            <el-table-column
                              prop="address"
                              ...
                              <template slot-scope="scope">
                                <vs-chip color="success">
                                  <b style="color: black; letter-spacing: 2px; font-size: 13px;">{{ scope.row.nombre }}</b>
                                </vs-chip>
                              </template>
                            </el-table-column>
                            <el-table-column
                            ...
                            <el-table-column
                              ...
                              label="Declaration">
                              <template slot-scope="scope">
                                <vs-button color="primary" type="flat" @click="showClient(scope.row)">{{ scope.row.n_declaration }}</vs-button>
                              </template>
                            </el-table-column>
                            <el-table-column
                              prop="address"
                      ...
                      <vs-col vs-w="12" style="display: grid;">
                        ...
                        <div style="border: 1px solid #8080802e; margin: 10px; padding: 15px;">
                          <h3>LISTE DES ZONES <el-link type="success" @click="ExportExcel('xls')"><img src="../assets/excel.png" width="14"> EXPORTER</el-link></h3>
                          <el-table
                            :data="donneesZones"
                            stripe
                            style="width: 100%; font-size: 13px;">
                            <el-table-column
                              ...
                              <template slot-scope="scope">
                                <vs-chip transparent color="primary">
                                  <vs-button color="primary" type="flat"><b>{{ scope.row.zone_facturation }}</b></vs-button>
                                </vs-chip>
                              </template>
                            </el-table-column>
                            <el-table-column
                              ...
                              label="Client">
                              <template slot-scope="scope">
                                  <b style="font-size: 11px;">{{ scope.row.mode }}</b>
                              </template>
                            </el-table-column>
                            <el-table-column
                              prop="name"
                              label="Client">
                              <template slot-scope="scope">
                                  <b style="font-size: 11px;">{{ scope.row.type_c }}</b>
                              </template>
                            </el-table-column>
                            <el-table-column
                              prop="name"
                              label="Armateur">
                              <template slot-scope="scope">
                                  <b style="font-size: 11px;">{{ scope.row.nombre }}</b>
                              </template>
                            </el-table-column>
                          </el-table>
                        </div>
  ...
  export default {
    ...
    methods: {
      ...
      listeDossiers () {
              ...
              axios.get('https://socogetra.net/appi_socogetra/soco_bilan_dossier2.php?timestamp=' + new Date().getTime())
              .then((response) => {
      ...
      listeZones2 () {
        ...
        ExportExcels(type, fn, dl) {
            var elt = this.$refs.exportable_tables;
        ...
        Stats() {
            ...
            axios.get('https://socogetra.net/appi_socogetra/soco_bilan_armateur2.php?timestamp=' + new Date().getTime())
            .then((response) => {

<template>
    <div class="hello" :key="cacheKey">
        <div class="screenUse">
            ...
            <vs-col vs-w="9.5" style="overflow:scroll; height: calc(100vh - 48px);">
              <div style="position: fixed; width: calc(79% - 13px); z-index: 1000;">
                ...
                <div style="width: 730px; float: left; display: inline-block; margin-bottom: -15px; color: black; font-size: 20px;">
                  <span style="color: #C32D39;"><vs-icon icon="home" size="" style="font-size: 18px;"></vs-icon> Administration /</span> Donneurs d'ordres 
                 
                </div>
                <span style="float: right; margin-right: 150px;">
                      <vs-button color="#C32D39"  icon="note_add" style="padding: 5px; position: absolute; width: 150px;" @click="activePrompt2=true">Créer un client</vs-button>
                  </span>
              ...
              <div style="padding: 10px 5px; font-family:'Karla', sans-serif; margin-top: 120px;">
                  ...
                  <h2 style="font-weight: bold;">Liste des clients </h2>
                  ...
                  <vs-table search maxItems="7" :pagination="true" stripe :data="donnees">
                    ...
                    <template slot-scope="{data}">
                      <vs-tr :key="indextr" v-for="(tr, indextr) in data" >
                        <vs-td :data="data[indextr].id_client">
                          <el-link type="primary"><i class="el-icon-document"></i> {{data[indextr].libelle}}</el-link>
                          
                        </vs-td>

                        <vs-td :data="data[indextr].id_client">
                            <vs-chip>
                              <b style="font-size: 16px">{{data[indextr].contacts}}</b>
                            </vs-chip>
                        </vs-td>

                        <vs-td :data="data[indextr].id_client">
                          <b>{{data[indextr].emails}}</b>
                        </vs-td>
          ...
          <vs-popup classContent="popup-example"  title="Nouveau Dossier" :active.sync="activePrompt2">
          <div>
            <vs-row>
              <vs-col style="padding: 5px;" vs-justify="center" vs-align="center" vs-w="4">
                <label>Date Contrat</label>
                <el-input   type="date" v-model="form.date_contrat" placeholder="Date dossier">
                </el-input>
              </vs-col>
              <vs-col style="padding: 5px;" vs-justify="center" vs-align="center" vs-w="4">
                <label>Libelle</label>
                <el-input v-model="form.libelle" placeholder="Libelle">
                </el-input>
              </vs-col>
              <vs-col style="padding: 5px;" vs-justify="center" vs-align="center" vs-w="4">
                <label>Site</label>
                <el-input v-model="form.site" placeholder="Site">
                </el-input>
              </vs-col>
            </vs-row>
            <vs-row>
                <vs-col style="padding: 5px;" vs-justify="center" vs-align="center" vs-w="12">
                    <label>Emails</label>
                    <el-input v-model="form.emails" placeholder="Emails">
                    </el-input>
                </vs-col>
                <vs-col style="padding: 5px;" vs-justify="center" vs-align="center" vs-w="12">
                    <label>Contacts</label>
                    <el-input v-model="form.contacts" placeholder="Contacts">
                    </el-input>
                </vs-col>
                <vs-col style="padding: 5px;" vs-justify="center" vs-align="center" vs-w="12">
                    <label>Commentaires</label>
                    <el-input v-model="form.commentaires" placeholder="Commentaires">
                    </el-input>
                </vs-col>
          ...
          <center><vs-button style="margin: 20px; width: 300px;" @click="onSubmit()" color="primary" type="filled">Enregistrer le client</vs-button></center>
    ...
    methods: {
        ...
        onSubmit() {
          console.log(this.form);
              axios.post('https://socogetra.net/appi_socogetra/soco_donneur_ordres.php', this.form)
              .then((response) => {
                  console.log(response);
                  this.listeOrdres();
